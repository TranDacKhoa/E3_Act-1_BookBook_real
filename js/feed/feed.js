import { data_images, data_user, data_user_other, data_blog } from '../data.js'; // data fake
import { comment, post, suggest_friends, blog } from './view.js';

// load view
post(data_images);
suggest_friends(data_user_other);
blog(data_blog);
//nav header
