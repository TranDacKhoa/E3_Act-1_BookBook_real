...
input_file_avatar.addEventListener('change', (e) => {
   ...
   if (file_avatar) {
      ...
      avatar_wrap.innerHTML = `<img src="../public/image/new.jpg" alt="" />`;
   }
});
...
const load_modal_edit = () => {
   ...
   data_user.gender === 'male'
      ? male.setAttribute('checked', true) && female.setAttribute('checked', false)
      : female.setAttribute('checked', true) && male.setAttribute('checked', false);
