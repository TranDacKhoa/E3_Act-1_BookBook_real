...
ALTER TABLE IF EXISTS public.general_post
    ADD CONSTRAINT fk_gpost_usr FOREIGN KEY (author_username)
...
ALTER TABLE IF EXISTS public.market_post
    ADD CONSTRAINT fk_mpost_usr FOREIGN KEY (post_by)
    REFERENCES public.user_profile (username) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
