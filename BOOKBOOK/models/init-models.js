...
function initModels(sequelize) {
  ...
  //   foreignKey: "usr_followed",
  // });
  // user_profile.hasMany(follow, { as: "following", foreignKey: "usr_follow" });
  ...
  // general_post.hasOne(user_wall, {
  //   foreignKey: "post_id",
  // });
  // user_wall.belongsTo(general_post, {
  //   sourceKey: "post_id",
  //   foreignKey: "post_id",
  // });
  // //
  ...
  // //
  // group_reported_member.hasOne(group_member, {
  //   sourceKey: "member",
  //   foreignKey: "username",
  // });
  // group_member.belongsTo(group_reported_member, {
  //   sourceKey: "username",
  //   foreignKey: "member",
  // });
  // group_reported_member.hasOne(group_member, {
